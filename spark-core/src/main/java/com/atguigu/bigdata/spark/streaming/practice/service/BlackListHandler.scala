...
import com.atguigu.bigdata.spark.streaming.practice.utils.JdbcUtil
...
object BlackListHandler {
  ...
  def addBlackList(filterAdsLogDSteam: DStream[Ads_log],timesToAddInBlackList: Int=30): Unit = {
