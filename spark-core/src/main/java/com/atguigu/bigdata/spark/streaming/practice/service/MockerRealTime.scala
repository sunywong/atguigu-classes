package com.atguigu.bigdata.spark.streaming.practice.service

import java.util.{Properties, Random}
import com.atguigu.bigdata.spark.streaming.practice.bean.CityInfo
import com.atguigu.bigdata.spark.streaming.practice.utils.{PropertiesUtil, RanOpt, RandomOptions}
...
import scala.collection.mutable.ArrayBuffer
  ...
  object MockerRealTime {
    ...
    def generateMockData(): Array[String] = {
      ...
      println("Random Array:"+array.size)
      array.toArray
  }
  ...
  val topic = "2ndTopics"
  println("------------ Start to create Kafka Producer ------------ ")
  // 创建 Kafka 消费者
