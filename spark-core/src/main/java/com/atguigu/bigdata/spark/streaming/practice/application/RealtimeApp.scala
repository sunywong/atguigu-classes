...
import com.atguigu.bigdata.spark.streaming.practice.service.BlackListHandler
import com.atguigu.bigdata.spark.streaming.practice.utils.MyKafkaUtil
...
object RealTimeApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //3.读取数据
    val kafkaDStream: InputDStream[ConsumerRecord[String, String]] = MyKafkaUtil.getKafkaStream("2ndTopics", ssc)
